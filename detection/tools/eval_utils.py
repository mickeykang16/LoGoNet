...
def eval_one_epoch(cfg, model, dataloader, epoch_id, logger, dist_test=False, save_to_file=False, result_dir=None):
    ...
    for i, batch_dict in enumerate(dataloader):
        ...
        with torch.no_grad():
            with CudaTimer(device=batch_dict['points'].device, timer_name="LoGoNet"):
...
def eval_one_epoch_private(cfg, model, dataloader, epoch_id, logger, dist_test=False, save_to_file=False, result_dir=None):
    result_dir.mkdir(parents=True, exist_ok=True)
    ...
    for i, batch_dict in enumerate(dataloader):
        ...
        if i % 5 == 0:
            print("inference time: ", batch_time / 5)
            batch_time = 0
