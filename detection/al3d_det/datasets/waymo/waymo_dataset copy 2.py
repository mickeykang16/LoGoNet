    ...
    def get_infos_and_points(self, idx_list):
        ...
        for i in idx_list:
            ...
            if 's3' in self.root_path:
                ...
                lidar_path = str(lidar_path).replace('/mnt1/LoGoNet/detection/data/waymo/waymo_processed_data_v4', '/ssd1tb_jy_3/waymo/processed_data_origin/waymo_processed_data_v4'
            ...
            for key in img_infos.keys():
                ...
                for j in range(1):
                    ...
                    if 's3' in self.root_path:
                        ...
                        img_path = str(img_path).replace('/mnt1/LoGoNet/detection/data/waymo/waymo_processed_data_v4', '/ssd1tb_jy_3/waymo/processed_data_origin/waymo_processed_data_v4')
